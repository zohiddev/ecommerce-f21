...
shopname.ae"
                ...
                <button>
                  <a href="https://www.ae.com/ca/en/?utm_source=google&utm_medium=sem-intlbrand&utm_content=ae&utm_campaign=nogender_general_general&utm_term=ae&gad_source=1&gclid=CjwKCAiA44OtBhAOEiwAj4gpOYGMd6rp5JqYwcYGSyp9UU3LCMhACoQfHlN5CsV_3ukDWpOC6FMtsxoCXvEQAvD_BwE">
                    <div className="flag-blok-1">
                      <img src={icon3} alt="" />
                      <div className="text">
                        <p>United States</p>
                ...
                <button>
                  <a href="https://aliexpress.ru/store/912462740?g=y&page=1">
                    <div className="flag-blok-1">
                      <img src={icon4} alt="" />
                      <div className="text">
                        <p>Russia</p>
                ...
                <button>
                  <a href="https://letyshops.com/ru/shops/17289199/go">
                    <div className="flag-blok-1">
                      <img src={icon5} alt="" />
                      <div className="text">
                        <p>Italy</p>
              ...
              <div className="flag-block">
                ...
                <button>
                  <a href="https://www.sofascore.com/france-denmark/BObsGOb">
                    <div className="flag-blok-1">
                      <img src={icon7} alt="" />
                      <div className="text">
                        <p>France</p>
                ...
                <button>
                  <a href="https://www.emirates.com/ae/english/destinations/flights-from-dubai-to-denmark/">
                    <div className="flag-blok-1">
                      <img src={icon1} alt="" />
                      <div className="text">
                        <p>Arabic Emirates</p>
                ...
                <button>
                  <a href="https://www.britannica.com/place/China">
                    {" "}
                    <div className="flag-blok-1">
                      <img src={icon9} alt="" />
                      <div className="text">
                ...
                <button>
                  <a href="https://www.government.nl/topics/brexit/question-and-answer/which-countries-make-up-the-united-kingdom">
                    <div className="flag-blok-1">
                      <img src={icon10} alt="" />
                      <div className="text">
                        <p>Great Britain</p>
